...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <form action="verif_connexion.php" method="post">
      <label for="pseudo">Pseudo : </label><br /><input id="pseudo" type="text" name="pseudo_connexion" value=""><br />
      <label for="pass">Mot de passe : </label><br /><input id="pass" type="password" name="pass_connexion" value=""><br />
